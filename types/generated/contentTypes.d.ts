...
export interface ApiDatosArtistaDatosArtista
  extends Struct.CollectionTypeSchema {
  collectionName: 'datos_artistas';
  info: {
    displayName: 'Datos Artista';
    pluralName: 'datos-artistas';
    singularName: 'datos-artista';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FotoArtista: Schema.Attribute.Media<
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::datos-artista.datos-artista'
    > &
      Schema.Attribute.Private;
    Nombre: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    Redes: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
